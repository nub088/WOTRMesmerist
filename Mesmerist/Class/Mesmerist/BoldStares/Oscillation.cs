    ...
    public class Oscillation
    {
        ...
        public static void Configure()
        {
            ...
            BuffConfigurator.New(FeatName + "Buff", Guids.OscillationBuff)
                ...
                .AddUniqueBuff()
                .SetIcon(IconLoader.GetOr("Oscillation", BuffRefs.DebilitatingInjuryDisorientedEffectBuff.Reference.Get().Icon))
            ...
            FeatureConfigurator.New(FeatName, Guids.Oscillation)
                .SetDisplayName(DisplayName)
                .SetDescription(Description)
                .SetIcon(IconLoader.GetOr("Oscillation", AbilityRefs.TrueSeeing.Reference.Get().Icon))
                .SetIsClassFeature()
                .Configure();
        }
    }
